# Copilot Instructions for bluedot bootc Image Template
...
### 1. Rename ALL instances of `bluedot`

**Source of truth**: `Containerfile` line 9: `# Name: bluedot`
...
**Template Version**: bluedot (Enhanced with comprehensive Copilot instructions)  
